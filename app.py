...
client = MongoClient("mongodb+srv://manueldb:<konodio DA>@usuarios-progra3.jaqlo9e.mongodb.net/?appName=usuarios-progra3")
db = client['bdproyecto'] #Nombre de tu base de datos aquí
